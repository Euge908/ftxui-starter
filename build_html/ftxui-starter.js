...
function findWasmBinary() {
  return locateFile('ftxui-starter.wasm');
}
...
/** @type {function(string, boolean=, number=)} */
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(3, 0, 1, fd, op, varargs);
...
var _ftxui_on_resize = Module['_ftxui_on_resize'] = makeInvalidEarlyAccess('_ftxui_on_resize');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['ftxui_on_resize'] != 'undefined', 'missing Wasm export: ftxui_on_resize');
  ...
  _ftxui_on_resize = Module['_ftxui_on_resize'] = createExportWrapper('ftxui_on_resize', 2);
